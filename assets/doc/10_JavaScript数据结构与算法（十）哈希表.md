...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.5irlba213e00.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.52qzixg5w4s0.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.47l36021j8m0.png)
...
- 线性探测
  ...
  ![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.2pcxv1f720o0.png)

- 二次探测和再哈希化的性能

  二次探测和再哈希法性能相当，它们的性能比线性探测略好。由下图可知，随着装填因子的变大，平均探测长度呈指数形式增长，需要探测的次数也呈指数形式增长，性能不高。

  ![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.f06tizypf6g.png)

- 链地址法的性能

  可以看到随着装填因子的增加，平均探测长度呈线性增长，较为平缓。在开发中使用链地址法较多，比如 Java 中的 HashMap 中使用的就是链地址法。

  ![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.45s3ntwwjia0.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.4kz61djvvau0.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.7h3eahcbrvs0.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.2a81gwdznn8k.png)
...
![image](https://cdn.jsdelivr.net/gh/WTxiaomage/imgsbed/posts/image.7xrayvjwh2w.png)
